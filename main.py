...
root = tk.Tk()
root.geometry("300x375")  # '×' this symbol is brought by pressing alt+ 0 2 1 5  
...
btn_div = tk.Button(root, text="÷", command=lambda: add_to_calculation("/"), width=5, font=("Arial", 14))  #'÷' is used by alt+ 0 2 4 7
